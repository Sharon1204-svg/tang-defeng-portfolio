...
export default function Home(){
 return <main>
  ...
  <section className="min-h-screen flex items-center container-custom">
   <div>
    <p className="text-gray-500 mb-10">UX Designer · Mobility Experience Designer</p>
    <h1 className="text-7xl md:text-8xl tracking-tight leading-none font-medium max-w-5xl">Designing human-centered experiences for future mobility.</h1>
    <p className="mt-12 max-w-xl text-xl text-gray-600">Exploring the connection between people, intelligent products and digital experiences.</p>
   </div>
  </section>
  ...
  <section id="works" className="container-custom pb-32">
   ...
   <div className="space-y-32">{works.map((work,index)=><article key={work.title}>
    <div className="aspect-[16/9] bg-[#E8E6DF] flex items-center justify-center text-gray-500 mb-8">Project Image {index+1}</div>
  ...
  <section id="about" className="container-custom py-32 grid md:grid-cols-2 gap-16">
   <div className="aspect-[4/5] bg-[#DDDAD1] flex items-center justify-center">Portrait</div>
   <div><h2 className="text-5xl mb-8">About Me</h2><p className="text-lg leading-relaxed text-gray-700">I am a UX designer with a background in industrial design and user experience research. My work focuses on mobility experience, intelligent products and human-centered interaction.</p></div>
  </section>
