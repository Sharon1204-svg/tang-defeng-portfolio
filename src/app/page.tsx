 ...
 return <main className="bg-[#FAFAF8] text-[#111]">
  ...
  <section className="min-h-screen flex items-center container-custom">
   <div>
    ...
    <h1 className="text-7xl md:text-8xl tracking-tight leading-none font-medium max-w-5xl">Designing human-centered experiences between people, products and intelligent systems.</h1>
  ...
  <section id="works" className="container-custom pb-32">
   ...
   <div className="space-y-32">{works.map((work,index)=><article key={work.title}>
    <div className="aspect-[16/9] bg-[#E8E6DF] flex items-center justify-center text-gray-500 mb-8">Replace with project image</div>
  ...
  <section id="about" className="container-custom py-32 grid md:grid-cols-2 gap-16">
   <div className="aspect-[4/5] bg-[#DDDAD1] flex items-center justify-center">Tang Defeng Portrait</div>
   <div>
    <h2 className="text-5xl mb-8">About Me</h2>
    <p className="text-lg leading-relaxed text-gray-700">I am a UX designer with a background in industrial design and user experience research. My work focuses on mobility experience, intelligent products, automotive HMI and human-centered interaction.</p>
   </div>
  </section>
